        ...
        tabItems(
          tabItem(tabName = "overview",
                  fluidRow(
                    boxPlus(
                      ...
                      p("The US rural economy is diverse and changing. Increasingly, the share of workers in service jobs is overtaking traditional industries, such as manufacturing and agriculture (Laughlin, 2016). As a result, it is important for counties to be nimble in approach to workforce training.  This also demonstrates to HGBs that counties have the capacity to train a skilled workforce for new opportunities in high-growth areas, like information technology."),
          ...
          tabItem(tabName = "builtcapital",
                  fluidRow(
                    ...
                    p("In many respects, Wythe County is uniquely endowed with built amenities attractive to businesses (William and Lamb, 2010).  It is situated at the intersection of two major interstates, and it is within a six-to-eight-hour drive of most of the population in the United States. As the map shows, it also has easy access to rail and other supporting infrastructure for commerce and manufacturing (e.g., powerplants). From an “access to major markets” perspective, Wythe is an attractive location for both light and heavy industry."),
                    img(src = 'infrastructure.png', height = "450", width = "600", align = "center"),
                    h2("Land & Housing"),
                    p("One of the attractive features of rural America is the cost of land and housing.  Accordingly, technology companies, which often require land intensive sites for data centers, may find rural locations increasingly appealing. The cost of housing, the low time travel cost, and the attractive recreational and natural amenities may also be important attributes to attract and retain employers and employees alike. The cost of housing in Wythe is very reasonable; a large proportion of homes are valued below $150,000. The housing stock in Wythe is, however, aging and limited (see graphs in dashboard below)."),
                    boxPlus(
          ...
          tabItem(tabName = "humancapital",
                  fluidRow(
                    ...
                    p("Third, households in Wythe County are relatively small. The majority of households have one or two people. Given the median age and proportion of the population under the age of 34, it is doubtful that the population of Wythe is overly skewed toward older workers and retired individuals, as the prevalence of one-person and two-person households might otherwise suggest. "),
                    h3("References:"),
