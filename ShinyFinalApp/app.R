        ...
        tabItems(
          tabItem(tabName = "overview",
                  fluidRow(
                    boxPlus(
                      ...
                      p("Wythe County is a rural community in southwestern Virginia with a population of 28,684 (2019 estimate). It was founded in 1790 and sits at the confluence of two major highways, Interstates 77 and 81, which facilitate easy access to major markets and population centers along the Eastern Seaboard and in Midwestern and Southern states more broadly. In recent years, Wythe County has had success in luring manufacturing facilities and travel-related businesses, and it has worked to expand the variety of tourism and hospitality options available. Like other communities in Appalachia, it has faced a declining population over the past decade. As a result, county leaders are seeking new ways to attract and retain companies, workers and residents. "),
                      br(),
                      ...
                      p("In their article “Developing High Growth Businesses in Rural Areas: A study of Four States,” William and Lamb (2010) note the key characteristics that a county can use to attract high growth businesses (HGBs). We will focus on three of them: (1) having a skilled and educated workforce, (2) access to research institutions, and (3), access to broadband. We expanded on their idea of “access to research institutions” because education and job skills for many well-paying jobs can be provided by community colleges or the equivalent. Job skill enhancements can also be made through work force training sites, and high schools can provide important training certificates in computer science, cyber security, and so on."),
                      p("The US rural economy is diverse and changing. Increasingly, the share of workers in service jobs is overtaking traditional industries such as manufacturing and agriculture (Laughlin, 2016). As a result, it is important for counties to be nimble in their ability to train their workforce.  This also demonstrates to potential HGBs that counties have the capacity to train a skilled workforce for new opportunities. It may also be important to build on related initiatives within the region to uniquely position their workforce for employment in HGBs such as in the high-tech industry."),
          ...
          tabItem(tabName = "data",
                  fluidRow(
                    boxPlus(
                      ...
                      p("We used O*Net to gathered industry/occupation data for occupations that have a “bright outlook” which is defined as having an expectation of growth over the next several years. We also gather the skills, education, work experience, and training needed for these occupations and list them if greater than 40% of people listed needing them for a particular career."),
                      br(),
                      br(),
                      br(),
                      img(src="OSM.jpg", height="100", width="200", alt="Image", style="float: left; margin: 3px 12px 3px 0px; border: 1px solid #000000;"),
                      br(),
                      p("We used OpenStreetMap and the VirginiaWorks data to construct time-to-travel measures for access to education and workforce training. With this data we were then able to map floating catchment areas for various time windows in around Wythe County. "),
                      br(),
                      h2("Methodology"),
                      p("One of the central aims of this project is to create comparable measures of accessibility to educational facilities in the county.  In rural areas, metrics such as distance do not have the same interpretation as they do in urban areas. Large distances in rural areas can often be traversed quickly due to lower traffic density and a lack of other traffic impediments. To create our accessibility measures, we rely on travel time, which accounts for both distance and traffic flow. We construct accessibility measures for each county in the region by estimating the travel time between the county population weighted centroid and foci for educational and workforce training (Waldorf and Chen, 2010). We use a floating catchment area around each county centroid and vary the size of the travel time window to include 30, 45, and 60 min windows for each catchment area. We then count the services by type within each of the travel time windows. This allows us, for each county, to construct:"),
          ...
          tabItem(tabName = "builtcapital",
                  fluidRow(
                    ...
                    p("To understand the full suite of amenities available to HGBs in Wythe, we joined, mapped, and graphed publicly available demographic and infrastructure data to provide an overview of the built capital amenities in Wythe."),
                    p("In many respects, Wythe County is uniquely endowed with built amenities attractive to businesses (William and Lamb, 2010).  It is situated at the intersection of two major interstates, and it is within a six-to-eight-hour drive of most of the population in the United States. As the map shows, it also has easy access to rail and other supporting infrastructure for commerce and manufacturing (e.g., powerplants). This means that, from an “access to major markets” perspective, Wythe is an attractive location for both light and heavy industry."),
                    img(src = 'infrastructure.png', height = "450", width = "600", align = "center"),
                    h2("Land & Housing"),
                    p("One of the attractive features of rural America is the cost of land and housing. Many technology companies that want to build land intensive sites (such as data centers) may find rural locations increasingly attractive. The cost of housing, the low time travel cost, and the attractive recreational and natural amenities may also be important attributes to attract and retain employers and employees alike. The cost of housing in Wythe is very reasonable with a large proportion of homes valued below $150,000. The housing stock in Wythe is, however, aging and limited (see graphs in dashboard below)."),
                    boxPlus(
          ...
          tabItem(tabName = "humancapital",
                  fluidRow(
                    ...
                    p("Investing in human capital is yet another way of attracting and retaining HGBs. It can also provide an engine for entrepreneurship. Wythe has a total population of 29,000 with 13,000 documented as employees. The median age of the population in Wythe county is 44 with approximately 42 percent of the population being under that age of 34. Because of its size, Wythe’s actual labor market pool is much larger than its population as it is easily within a 60-minute drive of many of the adjoining counties as seen in the map below. The white cloud on the map surrounding Wythe represents all parts of the region that are within a 60-minute drive from the center of the county (the red dot)."),
                    br(),
                    boxPlus(
                    ...
                    br(),
                    p("As you may observe in the dashboard above, there are other important features of Wythe’s labor market we should note in terms of industry concentration, salary, and household size."),
                    h4("The workforce in Wythe County are working primarily in the health, education, manufacturing, and retail industries. "),
                    p("Outside of education and healthcare, most workers in Wythe are in the retail sector. While these types of service jobs are important, it should be recognized that these are not jobs that are typically associated with high earning potential. Moreover, ecommerce is continuing to crowd out many of these types of businesses. From an economic growth perspective, it is therefore important to continue to focus on diversifying the industrial base. "),
                    
                    h4("Most of the workforce make between $35,000-$150,000."),
                    p("The majority of households in Wythe earn income in the range of $25,000 to $150,000, with those earning between $50,000 and $75,000 representing the median household income."),
                    h4("Households in Wythe County are relatively small."),
                    p("The majority of the households in Wythe have one or two people. Given the  median age and proportion of the population under the age of 34, it is doubtful that the population of Wythe is overly skewed toward older workers and retired individuals, as might otherwise be suggested by the prevalence of one- and two-person households. "),
                    h3("References:"),
          ...
          tabItem(tabName = "jobs",
                  fluidRow(
                    ...
                    p("Given the sizeable role investments in human capital have on economic growth, knowledge of which industry, careers paths and occupations are growing in the U.S. could be very valuable when determining how and where to make investments. Equally as important is knowing which skills, education and training are necessary for individuals to be employed in each occupation, career and industry. This knowledge provides actionable information for preparing, teaching, and training the workforce of tomorrow. "),
                    p("Therefore, graphed above are five collapsible trees that map the O*NET career and occupation data. Each tree maps industry (the first level) to career pathways (second level) to occupations (third level).
                      This data represent industries, careers and occupations with the highest projected growth or brightest outlook. In addition, the dropdown menu allows for a fourth level. These trees map Skills, Education, Experience, On-Site-Training and On-Job-Training needed for each occupation, career and industry.
                      Therefore, these trees map the jobs of tomorrow to the skills, education and training necessary for each."),
                    p("Graphed above are five collapsible trees that map the O*NET career and occupation data. Each tree maps industry (the first level) to career pathways (second level) to occupations (third level). The data represent industries, careers and occupations with the highest projected growth or brightest outlook. In addition, the dropdown menu allows for a fourth level. These trees map Skills, Education, Experience, On-Site-Training and On-Job-Training needed for each occupation, career and industry. Therefore, these trees map the jobs of tomorrow to the skills, education and training necessary for each."),
                    p("Desired industries, as indicated by Wythe County officials, include manufacturing, agriculture, information systems and technology and food and beverage production. These can be found on the trees above."),
                    br()
                    )),
          tabItem(tabName = "access",
                  fluidRow(
                    h2("A Regional Comparison of Educational Access"),
                    p("An analysis of the trees (see previous tab) shows that many of the jobs in high growth careers are in information and technology. These jobs often require training in a host of critical areas, from customer support and client satisfaction to computer science and systems and electrical engineering. Aside from the heavy STEM focus in information technology, there is also a large need for people with skills in communication, education, and training, among others. Additionally, there are many high-paying jobs in the IT sector that do not require a college degree. IT jobs such as web developer, computer programmer, systems analyst, cybersecurity analyst, graphic designer, digital marketer, telecommunications technician, can be filled by individuals that have relevant skills but not necessarily a four-year degree. In such cases, not local community colleges and even high schools can help with IT skill development by providing courses and certification programs that are readily accessible to residents in Wythe County, particularly those without a four-year college degree."),
                    ...
                    p("The foregoing analysis motivated the team to examine Wythe County’s access to institutions that can provide high-quality, high-impact training. The dashboard above shows access measures for education and workforce training for Wythe County and the surrounding region. The workforce training, community college, and four-year college and university measures are counts of these locations within a chosen travel time from the population weighted county centroid."),
                    p("For example, Wythe County has three colleges and universities located within a 60-minute drive of most of the population. If, however, one narrows the time window to 30 minutes demonstrates there is only one. Further exploration of the dashboard shows that this institution is a community college, which, may play an important role in providing workforce training. As is clear from the colors on the maps, Wythe is well positioned in terms of access to continuing and higher education facilities."),
                    
                    br(),
                    h3("Broadband and High Schools"),
                    p("High schools also play a large role in training future workers. Trade and vocational programs can dictate the future career paths for many students who do not pursue additional education beyond a high school diploma. This second dashboard shows that Wythe County has three high schools."),
                    p("In this dashboard, we also display the percentage of the population who have access to broadband internet and who have a computer in the home. Online learning is an increasingly important and popular way to acquire additional skills and education. These visualizations allow us to assess Wythe’s ability to train the current and future workforce from home and to serve as a site for telework.  This is increasingly important given that so many aspects of education and work have moved online because of Covid-19."),
                    br()
                  )),
          ...
          tabItem(tabName = "team",
                  fluidRow(
                    boxPlus(
                      ...
                      p("Our project goal was to identify industry and the jobs in these industries that are expected to grow rapidly in the future. We visualized these jobs by the skills, education, experience and training needed to do them. We then created measure to visualize and assess the ability of Wythe County and surrounding region to respond to trainingthe workers of tomorrow. Our team is comprised of talented individuals with a broad range of skills and experience."),
